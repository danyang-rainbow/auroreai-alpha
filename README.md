...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/auroreai-alpha)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/auroreai-alpha
```

A live public deployment of this template is available at [https://auroreai-alpha.templates.workers.dev](https://auroreai-alpha.templates.workers.dev)
